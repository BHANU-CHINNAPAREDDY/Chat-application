  ...
  return (
    <div className='w-full h-full grid grid-cols-[48px,1fr] bg-white'>
            <div className='bg-slate-100 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-600 flex flex-col justify-between'>
                <div>
                    <NavLink to="/" className={({isActive})=>`w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded ${isActive && "bg-slate-200"}`} title='chat'>
                    ...
                    {user?.role !== 'admin' && (
                        <NavLink to="/broadcast" className={({isActive})=>`w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded ${isActive && "bg-slate-200"}`} title='Broadcast'>
                            <MdCampaign
                                size={20}
                            />
                        </NavLink>
                ...
                <div className=' h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto scrollbar'>
...

                    {
                        allUser.map((conv,index)=>{
                            // Special handling for broadcast conversation
                            if (conv._id === 'broadcast') {
                                return (
